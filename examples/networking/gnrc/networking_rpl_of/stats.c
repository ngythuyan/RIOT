...
static uint8_t standard = 0; // 0 = Radio, 1 = BLE
static network_size = (10); // 10/50/100
static packet_interval = (50); // in milliseconds; 50/500/1000
static of = 0; // 0 = OF0, 1 = MRHOF-ETX, 1 = MRHOF-Energy
...
static void *_sendloop(void *arg)
{
    ...
    ztimer_sleep(ZTIMER_USEC, random_uint32() >> 12);
...
int stats_cmd(int argc, char **argv)
{
    ...
    if (strcmp(argv[1], "start") == 0) {
        ...
        unsigned diff  = (ztimer_now(ZTIMER_MSEC) / MS_PER_SEC) - start_time;
...
int experiment_cmd(int argc, char **argv)
{
    static unsigned start_time;
    ...
    if (strcmp(argv[1], "start_root") == 0) {
        // TODO
    }
    else if (strcmp(argv[1], "start_send") == 0) {
        // TODO
    }
    else if (strcmp(argv[1], "stop_send") == 0) {
        // TODO
    }
    else if (strcmp(argv[1], "set_params") == 0) {
        // TODO
    }
    else {
        printf("Help:\n");
